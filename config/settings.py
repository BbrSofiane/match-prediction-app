...
APPS_DIR = BASE_DIR / "match_prediction_app"
...
LOCAL_APPS = ["match_prediction_app.core", "match_prediction_app.users"]
...
ACCOUNT_FORMS = {"signup": "match_prediction_app.users.forms.UserSignupForm"}
